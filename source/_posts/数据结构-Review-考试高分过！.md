...
复习一下课没好好上过的数据结构，唉！要期末考试噜！数据结构和算法要是想成为`Master`，好难欸！！~
...
<h5 id = "6.1.2"> 6.1.2 二分查找（折半查找） </h5>
...
3. 折半查找的平均查找长度：$$ASL_{bs} = \frac{1}{n}\sum_{i=1}^{n}{j\times2^{j-1}} = \frac{n+1}{n}\log_2(n+1) - 1 = \log_2(n+1) - 1 $$
4. 复杂度分析：最坏情况下，关键词比较次数为$\log_2(n+1)$，且期望时间复杂度为$O(log_2n)$；
...
> 更多哈希表的知识，请戳：
> * [浅谈哈希表(HashTable)](https://www.jianshu.com/p/dbe7a1ea5928) -> *recommend*！
...
> 更多折半插入排序的知识，请戳：
> * [数据结构折半插入排序](https://blog.csdn.net/m0_37316917/article/details/70990523) ->*recommend*！
